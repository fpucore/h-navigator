...
license=('MPL2')
depends=('x86_64-vendor' 'gcc' 'clang' 'ccache' 'gtk3' 'nss' 'alsa-lib' 'libxss' 'ttf-font' 'bc' 'nullfsvfs-dkms' 'dust')
...
source=("$pkgname.sh")
options=(!strip)
source_x86_64=("https://github.com/brave/brave-browser/releases/download/v1.97.29/brave-browser-nightly_1.97.29_amd64.deb")
sha512sums=('SKIP')
